...
Component({
  ...
  methods: {
    _onInit() {
      ...
      this.setData({
        pickerArray,
        // pickerIndex: [0, mdate.month, date.getDate() - 1, date.getHours()],
        pickerIndex: [0, 0, 0, date.getHours()],//默认选择年月日时分的第一个选择项
        chooseIndex: [0, mdate.month, date.getDate() - 1, date.getHours()],
