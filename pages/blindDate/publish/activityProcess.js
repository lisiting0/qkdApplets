...
Page({
  ...
  onLoad: function(options) {
    ...
    let activityProcessStorage = pubData.activityProcess;
    if (activityProcessStorage) {
      //将br替换成empty
      let newStorage = activityProcessStorage.replace("<br/>", "empty");
      // 正则提取数据 
  ...
  editorConfirm: function() {
    ...
    app.globalData.publishBlindDate.activityProcess = html;
    wx.navigateBack({
      delta: 1
    })
  }
